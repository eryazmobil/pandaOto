package eryaz.software.panda.ui.dashboard.counting.firstCounting.firstCountingDetail.countingInfo
...
import eryaz.software.panda.databinding.FragmentInfoFirstCountingBinding
...
class InfoFirstCountingFragment : BaseFragment() {
    ...
    private val productEdtAdapter by lazy(LazyThreadSafetyMode.NONE) {
        eryaz.software.panda.ui.dashboard.counting.adapter.InfoProductEdtAdapter().also {
